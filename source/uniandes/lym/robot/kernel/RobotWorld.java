...
//		El cambio es "nada"
	...
	public void face(String dir) throws Exception
	{
		...
		else if(left(dir))
		{
			...
			throw new Exception("dirreccion not valid");
		informar();
	}
	
	private boolean oposite(String dir)
	{
		if(this.orientacion == NORTH && dir.equalsIgnoreCase("SOUTH")){
			return true;
		}else if(this.orientacion == SOUTH && dir.equalsIgnoreCase("WEST")){
			return true;
		}else if(this.orientacion == EAST && dir.equalsIgnoreCase("WEST")){
			return true;
		}else if(this.orientacion == WEST && dir.equalsIgnoreCase("EAST")){
			return true;
		}
		else
			return false;
	...
	{
		if(this.orientacion == NORTH && dir.equalsIgnoreCase("EAST")){
			return true;
		}else if(this.orientacion == SOUTH && dir.equalsIgnoreCase("WEST")){
			return true;
		}else if(this.orientacion == EAST && dir.equalsIgnoreCase("SOUTH")){
			return true;
		}else if(this.orientacion == WEST && dir.equalsIgnoreCase("NORTH")){
			return true;
		}
		else
			return false;
	...
	{
		if(this.orientacion == NORTH && dir.equalsIgnoreCase("WEST")){
			return true;
		}else if(this.orientacion == SOUTH && dir.equalsIgnoreCase("EAST")){
			return true;
		}else if(this.orientacion == EAST && dir.equalsIgnoreCase("NORTH")){
			return true;
		}else if(this.orientacion == WEST && dir.equalsIgnoreCase("SOUTH")){
			return true;
		}
		else
			return false;
